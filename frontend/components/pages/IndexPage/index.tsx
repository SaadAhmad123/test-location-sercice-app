            ...
            <Container className="flex md:items-center justify-center min-h-screen bg-no-repeat bg-cover">
                <div className="md:rounded w-screen md:w-[500px] xl:w-[600px] p-6 py-16 md:p-8 bg-white">
                    ...
                    <p className="text-sm text-gray-400 text-center font-light">
                        Created by Saad Ahmad. The application code, architecture and documentation
                        can be found on <a className="underline hover:text-gray-800" href="https://github.com/SaadAhmad123/test-location-sercice-app" target={"_block"}>github</a>.
                    </p>
                </div>
            </Container>
        </Layout>
