...
export class API {
  ...
  endpoint(
    ...
    return {
      ...
      mock,
      method,
      resolve: function (params: { [key: string]: string }) {
   ...
   */
  static forEachEndpointIn(
    directory: any,
    callback: (path: string, endpoint: APIEndpoint) => void
  ) {
    try {
